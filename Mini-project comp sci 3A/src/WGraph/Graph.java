 ...
 * 
 * @param <T> The type of data stored in the graph nodes, must implement
 *            Comparable
 */
...
public class Graph<T extends Comparable<T>> {
	...
	/**
	 * Represents a node in the graph containing data and connections to other
	 * nodes.
	 * 
	...
	/**
	 * Represents a connection between two nodes in the graph with an associated
	 * weight.
	 * 
	...
	public static class GraphLink<T extends Comparable<T>> implements Comparable<GraphLink<T>> {
		...
		public boolean equals(Object obj) {
			...
			return weight == other.weight && fromNode.equals(other.fromNode) && toNode.equals(other.toNode);
		}
	...
	public static class NodeCostPair<T extends Comparable<T>> implements Comparable<NodeCostPair<T>> {
		...
		public boolean equals(Object obj) {
			if (this == obj)
				return true;
			if (!(obj instanceof NodeCostPair))
				return false;

			NodeCostPair<?> other = (NodeCostPair<?>) obj;
			return pathCost == other.pathCost && node.equals(other.node);
		}
	...
	public static class PathCostPair<T extends Comparable<T>> {
		...
		public boolean equals(Object obj) {
			if (this == obj)
				return true;
			if (!(obj instanceof PathCostPair))
				return false;

			PathCostPair<?> other = (PathCostPair<?>) obj;
			if (totalCost != other.totalCost)
				return false;
			if (pathLinks.size() != other.pathLinks.size())
				return false;
